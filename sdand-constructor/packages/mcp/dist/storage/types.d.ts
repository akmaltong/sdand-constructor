...
export declare class SceneVersionConflictError extends Error {
    readonly code: "version_conflict";
    constructor(message?: string);
}
export declare class SceneInvalidError extends Error {
    readonly code: "invalid";
    constructor(message?: string);
}
export declare class SceneTooLargeError extends Error {
