 ...
 */
export declare function throwMcpError(code: ErrorCode, message: string, data?: unknown): never;
/**
 ...
 */
export declare function toolError(message: string, data?: Record<string, unknown>): {
    content: {
        type: 'text';
        text: string;
    }[];
