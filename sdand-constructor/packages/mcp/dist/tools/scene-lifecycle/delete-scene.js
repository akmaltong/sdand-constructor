...
export function registerDeleteScene(server, operations) {
    server.registerTool('delete_scene', {
        title: 'Delete scene',
        description: 'Delete a scene from the SceneStore by id. Optionally pass `expectedVersion` for optimistic concurrency.',
