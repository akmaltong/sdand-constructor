...
export function registerListScenes(server, operations) {
    server.registerTool('list_scenes', {
        title: 'List scenes',
        description: 'List scenes in the SceneStore. Optionally filter by `projectId` and cap results with `limit` (default 100).',
