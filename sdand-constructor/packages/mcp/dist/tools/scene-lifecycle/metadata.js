...
export function editorUrlFor(meta) {
    return meta.editorUrl ?? meta.url ?? `/editor/${meta.id}`;
}
export function sceneMetaPayload(meta, graph) {
...
export function projectStatusPayload(status, nextStep) {
    return {
        id: status.id,
...
export function currentLevelContext(operations) {
