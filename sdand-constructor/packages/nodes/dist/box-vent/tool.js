...
import { BoxVentNode, emitter, sceneRegistry, useScene, } from '@pascal-app/core';
...
const BoxVentTool = () => {
    ...
    const previewNode = useMemo(() => BoxVentNode.parse({
    ...
    if (!activeBuildingId || !previewPos || !previewSurfaceQuat)
        return null;
    return (_jsx("group", { position: previewPos, children: _jsx("group", { "rotation-y": previewYaw, children: _jsx("group", { quaternion: previewSurfaceQuat, children: _jsx(BoxVentPreview, { node: previewNode }) }) }) }));
};
