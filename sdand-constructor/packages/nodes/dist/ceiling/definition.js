...
import { ceilingAddVertexAffordance, ceilingMoveEdgeAffordance, ceilingMoveVertexAffordance, } from './floorplan-affordances';
...
function ceilingPolygonCenter(n) {
 ...
 */
export const ceilingDefinition = {
    kind: 'ceiling',
    schemaVersion: 1,
    schema: CeilingNode,
    category: 'structure',
