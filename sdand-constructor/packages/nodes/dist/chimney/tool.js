...
import { ChimneyNode, emitter, sceneRegistry, useScene, } from '@pascal-app/core';
...
const ChimneyTool = () => {
    ...
    const previewNode = useMemo(() => ChimneyNode.parse({
    ...
    useEffect(() => {
        ...
        const onClick = (event) => {
            ...
            state.createNode(chimney, hit.segment.id);
