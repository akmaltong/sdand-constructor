...
import { COLUMN_PRESETS, ColumnNode, collectAlignmentAnchors, emitter, useScene, } from '@pascal-app/core';
import { getFloorStackPreviewPosition, triggerSFX, useAlignmentGuides, useEditor, usePlacementPreview, } from '@pascal-app/editor';
...
const DEFAULT_COLUMN_PRESET_ID = 'basicPillar';
function createColumnFromPreset(presetId, position) {
...
const ColumnTool = () => {
    ...
    if (!activeLevelId)
        return null;
    return (_jsx("group", { ref: cursorRef, visible: cursorVisible, children: _jsx(ColumnPreview, { node: previewNode }) }));
};
