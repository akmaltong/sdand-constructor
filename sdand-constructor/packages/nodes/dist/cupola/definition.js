import { CupolaNode as CupolaNodeSchema, } from '@pascal-app/core';
...
export const cupolaDefinition = {
    ...
    surfaceRole: 'roof',
    defaults: () => {
        const stub = CupolaNodeSchema.parse({ id: 'cupola_default', type: 'cupola' });
    ...
    mcp: {
        description: 'A louvered cupola (roof lantern) on a roof segment. Roof style: dome / pyramid, optional finial. Parametric width/depth/height.',
    },
};
