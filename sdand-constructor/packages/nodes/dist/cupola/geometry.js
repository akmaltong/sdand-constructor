 ...
 */
export function buildCupolaGeometry(node) {
...
function addBox(p, n, uv, hw, hd, y0, y1) {
    // Walls.
...
const SLAT_COUNT = 5;
function addLouvers(p, n, uv, hw, hd, y0, y1) {
    ...
    for (const { map, halfU } of faces) {
        ...
        const upOut = [outDir[0], 1, outDir[2]];
        const downOut = [outDir[0], -1, outDir[2]];
...
// ─── Roofs ───────────────────────────────────────────────────────────
function addPyramidRoof(p, n, uv, hw, hd, y0, apexY) {
...
function addDomeRoof(p, n, uv, rx, rz, y0, domeH) {
    const lng = 20;
    const lat = 6;
...
// ─── Finial primitives ───────────────────────────────────────────────
function addCylinder(p, n, uv, r, y0, y1) {
    const lng = 12;
...
function addSphere(p, n, uv, r, cy) {
    const lng = 14;
    const lat = 8;
