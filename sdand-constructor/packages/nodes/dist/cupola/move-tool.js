...
export default function MoveCupolaTool({ node }) {
    ...
    if (!(previewPos && previewSurfaceQuat))
        return null;
    return (_jsx("group", { position: previewPos, children: _jsx("group", { "rotation-y": previewYaw, children: _jsx("group", { quaternion: previewSurfaceQuat, children: _jsx(CupolaPreview, { node: node }) }) }) }));
}
