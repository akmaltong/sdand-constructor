import { EyebrowVentNode as EyebrowVentNodeSchema, } from '@pascal-app/core';
 ...
 */
export const eyebrowVentDefinition = {
    kind: 'eyebrow-vent',
    schemaVersion: 1,
    ...
    mcp: {
        description: 'A low curved eyebrow vent on a roof segment — a lens-shaped hood with an optional louvered front. Parametric width (span) / depth / height.',
    },
};
