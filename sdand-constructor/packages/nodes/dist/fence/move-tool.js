...
import { constrainWallMoveDeltaToAxis, emitter, getPerpendicularWallMoveAxis, useScene, } from '@pascal-app/core';
import { CursorSphere, markToolCancelConsumed, snapFenceDraftPoint, triggerSFX, useEditor, } from '@pascal-app/editor';
...
function getLinkedFenceUpdates(linkedFences, originalStart, originalEnd, nextStart, nextEnd) {
...
export const MoveFenceTool = ({ node }) => {
    ...
    useEffect(() => {
        ...
        const applyPreview = (nextStart, nextEnd) => {
            ...
            const previewUpdates = [
                ...
                ...getLinkedFenceUpdates(linkedOriginalsRef.current, originalStart, originalEnd, nextStart, nextEnd),
            ];
        ...
        const onGridMove = (event) => {
            ...
            const [deltaX, deltaZ] = constrainWallMoveDeltaToAxis(localX - anchor[0], localZ - anchor[1], moveAxisRef.current);
            const nextStart = [originalStart[0] + deltaX, originalStart[1] + deltaZ];
            const nextEnd = [originalEnd[0] + deltaX, originalEnd[1] + deltaZ];
        ...
        const onGridClick = (event) => {
            ...
            applyNodePreview([
                ...
                ...getLinkedFenceUpdates(linkedOriginalsRef.current, originalStart, originalEnd, preview.start, preview.end),
            ]);
            useScene.temporal.getState().pause();
