import { GutterNode as GutterNodeSchema, } from '@pascal-app/core';
...
function gutterLengthHandle(side) {
    ...
    return {
        ...
        apply: (initial, newLength, sceneApi) => {
            ...
            const snap = snapLengthToCorner(initial, newLength, sign, anchorX, anchorZ, armX, armZ, MIN_LENGTH, sceneApi);
...
export const gutterDefinition = {
    ...
    mcp: {
        description: 'A gutter strip running along the eave of a roof segment. Three profiles (k-style ogee fascia, half-round, square box), length / size / thickness parametric.',
    },
};
