 ...
 */
export function computeEaveY(segment) {
    ...
    if ((segment.roofType ?? 'gable') === 'flat')
        return wallHeight;
 ...
 *    becomes important.
 */
function pickEaveSide(roofType, localX, localZ, halfW, halfD) {
    if (roofType === 'shed')
        return '+Z';
...
export function resolveEaveSnap(segment, localX, localZ) {
