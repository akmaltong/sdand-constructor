 ...
 */
export function profileFloorMidZ(profile, size) {
 ...
 */
export function outletShapeForProfile(profile) {
 ...
 */
export function outletDims(shape, nominalDiameter) {
    const half = Math.max(0.01, nominalDiameter / 2);
    if (shape === 'round')
        return { shape, halfX: half, halfZ: half };
