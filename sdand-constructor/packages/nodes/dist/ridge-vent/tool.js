...
import { emitter, RidgeVentNode, sceneRegistry, useScene, } from '@pascal-app/core';
...
const RidgeVentTool = () => {
    ...
    const previewNode = useMemo(() => RidgeVentNode.parse({
    ...
    if (!activeBuildingId || !previewPos)
        return null;
    return (_jsx("group", { position: previewPos, children: _jsx("group", { "rotation-y": previewYaw, children: _jsx(RidgeVentPreview, { node: previewNode }) }) }));
};
