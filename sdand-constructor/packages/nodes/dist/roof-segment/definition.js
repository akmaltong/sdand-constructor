import { getActiveRoofHeight, getPitchFromActiveRoofHeight, RoofSegmentNode as RoofSegmentNodeSchema, } from '@pascal-app/core';
import { buildRoofSegmentFloorplan } from './floorplan';
import { roofSegmentMoveTarget, roofSegmentResizeAffordance, roofSegmentRotateAffordance, } from './floorplan-affordances';
...
function roofSegmentWidthHandle(side) {
...
function roofSegmentDepthHandle(side) {
...
function roofSegmentWallHeightHandle() {
    return {
        kind: 'linear-resize',
        axis: 'y',
        anchor: 'min',
...
function roofSegmentPitchHandle() {
    return {
        kind: 'linear-resize',
        axis: 'y',
        anchor: 'min',
...
function roofSegmentRotateHandle() {
    return {
        kind: 'arc-resize',
        axis: 'angular',
        shape: 'rotate',
 ...
 */
export const roofSegmentDefinition = {
    kind: 'roof-segment',
    schemaVersion: 1,
