 ...
 */
export function buildRoofSegmentFloorplan(node, ctx) {
    const roof = ctx.parent;
    ...
    const points = corners.map(([x, y]) => toPlan(x, y));
 ...
 */
export function getRoofSegmentPlanLinework(node) {
