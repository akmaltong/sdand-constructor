import { createDefaultMaterial, createSurfaceRoleMaterial, } from '@pascal-app/viewer';
...
const roofMaterialsCache = new Map();
export function getRoofMaterials(shading = 'rendered', textures = true, colorPreset = 'clay') {
...
const roofDebugMaterialsCache = new Map();
export function getRoofDebugMaterials(shading = 'rendered') {
