 ...
 */
export function buildShelfFloorplan(node, ctx) {
    ...
    const localXInPlan = [cosR, sinR];
    const localZInPlan = [-sinR, cosR];
    const children = [footprintGroup];
    const emitResizeArrow = (dim, localAxis, localOffset) => {
        const planAxis = [
