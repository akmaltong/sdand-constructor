 ...
 */
export const slabMoveVertexAffordance = createPolygonVertexAffordance('slab');
export const slabAddVertexAffordance = createPolygonAddVertexAffordance('slab');
export const slabMoveEdgeAffordance = createPolygonMoveEdgeAffordance('slab');
