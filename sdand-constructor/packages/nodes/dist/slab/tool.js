...
function commitSlabDrawing(levelId, points) {
...
export const SlabTool = () => {
    ...
    useEffect(() => {
        ...
        emitter.on('slab:commit', onSlabCommit);
        return () => {
            ...
            emitter.off('slab:commit', onSlabCommit);
        };
    ...
    useEffect(() => {
        ...
        const linePoints = points.map(([x, z]) => new Vector3(x, y, z));
    ...
    return (_jsxs("group", { children: [_jsx(CursorSphere, { ref: cursorRef }), previewShape && (_jsxs("mesh", { frustumCulled: false, layers: EDITOR_LAYER, position: [0, levelY + Y_OFFSET, 0], rotation: [-Math.PI / 2, 0, 0], children: [_jsx("shapeGeometry", { args: [previewShape] }), _jsx("meshBasicMaterial", { color: "#818cf8", depthTest: false, opacity: 0.15, side: DoubleSide, transparent: true })] })), _jsxs("line", { frustumCulled: false, layers: EDITOR_LAYER, 
                // @ts-expect-error
                ...
                // @ts-expect-error
                ref: closingLineRef, renderOrder: 1, visible: false, children: [_jsx("bufferGeometry", {}), _jsx("lineBasicNodeMaterial", { color: "#818cf8", depthTest: false, depthWrite: false, linewidth: 2, opacity: 0.5, transparent: true })] }), points.map(([x, z], index) => (_jsx(CursorSphere, { color: "#818cf8", height: 0, position: [x, levelY + Y_OFFSET + 0.01, z], showTooltip: false }, index)))] }));
};
