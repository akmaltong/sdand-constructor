...
const iconPoint = (x, y) => `${formatIconCoord(x - FOOTPRINT_ICON_CENTER)} ${formatIconCoord(y - FOOTPRINT_ICON_CENTER)}`;
const iconY = (y) => formatIconCoord(y - FOOTPRINT_ICON_CENTER);
const iconX = (x) => formatIconCoord(x - FOOTPRINT_ICON_CENTER);
 ...
 */
export function buildSpawnFloorplan(node, ctx) {
...
function formatIconCoord(value) {
