...
import { emitter, SpawnNode, sceneRegistry, useScene } from '@pascal-app/core';
...
function getLevelLocalPosition(levelId, event) {
...
const SpawnTool = () => {
    ...
    if (!activeLevelId)
        return null;
    return _jsx(CursorSphere, { color: "#818cf8", height: 2.2, ref: cursorRef });
};
