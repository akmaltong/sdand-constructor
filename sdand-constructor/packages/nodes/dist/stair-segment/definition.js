import { StairSegmentNode as StairSegmentNodeSchema, } from '@pascal-app/core';
...
// chain re-center.
function stairSegmentWidthHandle(side) {
    return {
        kind: 'linear-resize',
        axis: 'x',
...
function stairSegmentLengthHandle() {
    return {
        kind: 'linear-resize',
        axis: 'z',
        anchor: 'min',
...
function stairSegmentHeightHandle() {
    return {
        kind: 'linear-resize',
        axis: 'y',
        anchor: 'min',
...
function stairSegmentHandles(node) {
    const handles = [
 ...
 */
export const stairSegmentDefinition = {
    kind: 'stair-segment',
    schemaVersion: 1,
