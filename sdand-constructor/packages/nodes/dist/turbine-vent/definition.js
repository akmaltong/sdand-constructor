import { TurbineVentNode as TurbineVentNodeSchema, } from '@pascal-app/core';
...
function turbineVentDiameterHandle() {
    return {
        kind: 'linear-resize',
        axis: 'x',
        anchor: 'center',
...
function turbineVentHeightHandle() {
    return {
        kind: 'linear-resize',
        axis: 'y',
        anchor: 'min',
...
export const turbineVentDefinition = {
    ...
    surfaceRole: 'roof',
    defaults: () => {
        const stub = TurbineVentNodeSchema.parse({ id: 'tvent_default', type: 'turbine-vent' });
    ...
    mcp: {
        description: 'A spinning turbine (whirlybird) vent on a roof segment. Style: globe / cylinder. Parametric diameter/height/neckHeight/vaneCount and idle spinSpeed.',
    },
};
