...
export default function MoveTurbineVentTool({ node }) {
    ...
    if (!(previewPos && previewSurfaceQuat))
        return null;
    return (_jsx("group", { position: previewPos, children: _jsx("group", { "rotation-y": previewYaw, children: _jsx("group", { quaternion: previewSurfaceQuat, children: _jsx(TurbineVentPreview, { node: node }) }) }) }));
}
