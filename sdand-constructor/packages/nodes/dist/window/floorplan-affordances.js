 ...
 */
export const windowWidthAffordance = {
    start({ node, payload, nodes, initialPlanPoint }) {
        ...
        const anchorX = side === 'end' ? initialWindowX - initialWidth / 2 : initialWindowX + initialWidth / 2;
        ...
        return {
            ...
            apply({ planPoint }) {
                ...
                const newWidth = Math.min(Math.max(MIN_WINDOW_WIDTH, initialWidth + delta), Math.max(MIN_WINDOW_WIDTH, maxWidth));
