 ...
 */
export const windowFloorplanMoveTarget = ({ node }) => {
    const startLevelId = (() => {
    ...
    const session = {
        ...
        apply({ planPoint, modifiers }) {
            ...
            const { clampedX, clampedY } = clampToWall(hit.wall, snappedLocalX, startLocalY, node.width, node.height);
            lastValid = {
