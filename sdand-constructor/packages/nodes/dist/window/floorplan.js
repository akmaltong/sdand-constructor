 ...
 */
export function buildWindowFloorplan(node, ctx) {
    ...
    const mullionStart = [cx - dirX * halfWidth, cz - dirZ * halfWidth];
    const mullionEnd = [cx + dirX * halfWidth, cz + dirZ * halfWidth];
    const children = [
