import { ZoneNode as ZoneNodeSchema } from '@pascal-app/core';
import { buildZoneFloorplan } from './floorplan';
import { zoneAddVertexAffordance, zoneMoveEdgeAffordance, zoneMoveVertexAffordance, } from './floorplan-affordances';
 ...
 */
export const zoneDefinition = {
    kind: 'zone',
    schemaVersion: 1,
    schema: ZoneNode,
    category: 'site',
    defaults: () => {
        const stub = ZoneNodeSchema.parse({ id: 'zone_default', type: 'zone' });
