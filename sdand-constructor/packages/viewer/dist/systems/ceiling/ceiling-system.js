import { getEffectiveNode, nodeRegistry, sceneRegistry, useLiveTransforms, useScene, } from '@pascal-app/core';
 ...
 */
function collectCeilingHoles(ceiling, nodes) {
    const holes = [];
 ...
 */
function updateCeilingGeometry(node, mesh, extraHoles = []) {
 ...
 */
export function generateCeilingGeometry(ceilingNode, extraHoles = []) {
